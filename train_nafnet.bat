...
echo.
echo ========================================
echo  NAFNet Training Info
echo ========================================
echo.
echo NAFNet processes images at FULL RESOLUTION.
echo No cropping or resizing is applied.
echo.
echo Memory usage scales with image size.
echo If you run out of VRAM, try:
echo   - Reducing batch_size to 1
echo   - Setting max_size in config to limit dimensions
echo   - Using variant: "lite" for smaller model
echo.
echo Starting NAFNet training...
echo Output will be saved to: outputs_nafnet\
echo.
...
echo ========================================
echo.
echo Results saved to outputs_nafnet\
echo.
pause
